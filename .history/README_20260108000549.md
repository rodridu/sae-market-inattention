...
### Installation
```bash
git clone https://github.com/yourusername/sae-market-inattention.git
...
- Chen et al. (2024): "Measuring information in earnings announcements with machine learning"
...
Built in 3 months as a research project exploring how algorithmic systems process corporate disclosures. Code went through multiple iterations debugging real-world data issues and pivoting when methods failed empirically.
